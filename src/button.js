...
if (button !== null) {
    document.head.insertAdjacentHTML('beforeend', '<link rel=stylesheet href="https://raw.githubusercontent.com/AntohMush/mpesa_button@master/styles/style.css">');
    img = '<img style="width: 35px; display: inline; margin: -8px;" src= "https://raw.githubusercontent.com/AntohMush/mpesa_button@master/images/mpesa.png">'
